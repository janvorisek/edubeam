...
Оригінальну [desktop‑версію](https://www.oofem.org/wiki/doku.php?id=edubeam:edubeam) створили [Bořek Patzák](http://ksm.fsv.cvut.cz/~bp/), [Jan Stránský](https://mech.fsv.cvut.cz/~stransky/) та [Vít Šmilauer](https://mech.fsv.cvut.cz/~smilauer/).

## Долучайтеся

Будемо раді вашим внескам у розвиток EduBeam:

1. **Код:** допоможіть з реалізацією нових можливостей у [GitHub‑репозиторії](https://github.com/janvorisek/edubeam).
2. **Тестування:** повідомляйте про помилки та пропозиції через [issue tracker](https://github.com/janvorisek/edubeam/issues).
